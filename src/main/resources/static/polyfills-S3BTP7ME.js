      ...
      (function (c) {
        typeof a[c] == 'function'
          ...
          : Ze($[e].prototype, c, {
              set: function (u) {
                typeof u == 'function'
                  ? ((this[re][c] = xe(u, e + '.' + c)), le(this[re][c], u))
                  : (this[re][c] = u);
              },
              get: function () {
                return this[re][c];
...
function mt(e, n, a, t) {
  ...
  function ne(k, d) {
    ...
    let A = function (o) {
        if (!N.isExisting)
          return R.call(N.target, N.eventName, N.capture ? j : U, N.options);
      },
      r = function (o) {
        if (!o.isRemoved) {
        ...
        if (o.allRemoved)
          return m.call(o.target, o.eventName, o.capture ? j : U, o.options);
      },
      i = function (o) {
        ...
        return function () {
          ...
          if (ue) {
            for (let fe = 0; fe < ue.length; fe++)
              if (D === ue[fe])
                return J ? o.call(P, D, L, Q) : o.apply(this, arguments);
          }
          ...
          if (de) {
            if (((We = !0), X)) {
              for (let fe = 0; fe < de.length; fe++) if (ge(de[fe], L)) return;
            }
          } else de = P[Ue] = [];
          let Pe,
          ...
          if (
            ...
            pe && (pe.taskData = null),
            Be && (Q.once = !0),
            (!Ee && typeof oe.options == 'boolean') || (oe.options = Q),
            (oe.target = P),
            (oe.capture = De),
            (oe.eventName = D),
    ...
    return (
      ...
      (g[_] = function () {
        ...
        for (let S = 0; S < b.length; S++) {
          let p = b[S],
            P = p.originalDelegate ? p.originalDelegate : p.callback;
          h.push(P);
        }
        return h;
      }),
        ...
        if (l) {
          ...
          if (h) {
            ...
            if (p) {
              ...
              for (let L = 0; L < D.length; L++) {
                let B = D[L],
                  J = B.originalDelegate ? B.originalDelegate : B.callback;
        ...
        if (typeof I[0] == 'function') {
          ...
          return (
            ...
            j &&
              ...
              ((U.ref = j.ref.bind(j)), (U.unref = j.unref.bind(j))),
...
function Ct(e) {
  e.__load_patch('legacy', (n) => {
    ...
    e.__load_patch('timers', (n) => {
      let a = 'set',
        t = 'clear';
      _e(n, a, t, 'Timeout'), _e(n, a, t, 'Interval'), _e(n, a, t, 'Immediate');
    }),
    ...
    e.__load_patch('XHR', (n, a) => {
      ...
      function C(T) {
        ...
        let W = ae(
            ...
            () =>
              function (R, m) {
                return (R[c] = m[2] == !1), (R[E] = m[1]), W.apply(R, m);
              }
          ),
          ...
          F = ae(
            ...
            () =>
              function (R, m) {
                if (a.current[g] === !0 || R[c]) return F.apply(R, m);
                {
                  let O = {
                      target: R,
                      url: R[E],
            ...
            () =>
              function (R, m) {
                ...
                if (O && typeof O.type == 'string') {
                  ...
                  O.zone.cancelTask(O);
                } else if (a.current[V] === !0) return N.apply(R, m);
              }
          );
      }
    }),
    ...
    function Y(f, o, l) {
      ...
      if (f[k] === g) {
        ...
        if (
          ...
          for (let p = 0; p < S.length; ) i(f, S[p++], S[p++], S[p++], S[p++]);
          if (S.length == 0 && o == N) {
            f[k] = R;
            let p = l;
            try {
        ...
        () => {
          try {
            let P = f[d],
              D = !!l && G === l[G];
            D && ((l[W] = P), (l[X] = S));
            let L = o.run(p, void 0, D && p !== z && p !== ne ? [] : [P]);
            Y(l, !0, L);
          } catch (P) {
            Y(l, !1, P);
          }
      ...
      static allWithCallback(o, l) {
        ...
        for (let L of o) {
          ...
          try {
            L.then(
              (J) => {
                (D[B] = l ? l.thenCallback(J) : J), p--, p === 0 && h(D);
              },
              (J) => {
                l ? ((D[B] = l.errorCallback(J)), p--, p === 0 && h(D)) : b(J);
              }
            );
          } catch (J) {
            b(J);
