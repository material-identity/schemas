...
public class SchemaController {
    ...
    public ResponseEntity<byte[]> render(@RequestParam(EndpointParamConstants.SCHEMA_TYPE_PARAM) SchemasAndVersions.SchemaTypes schemaType, @RequestParam(EndpointParamConstants.SCHEMA_VERSION_PARAM) String schemaVersion, @RequestParam(EndpointParamConstants.LANGUAGES_PARAM) String[] languages, @RequestBody JsonNode certificate) throws TransformerException, IOException, SAXException {
    ...
    public ResponseEntity<Map<String, Object>> validate(@RequestParam("schemaType") String schemaType, @RequestParam("schemaVersion") String schemaVersion, @RequestBody JsonNode jsonCertificate) throws IOException {
