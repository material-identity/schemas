      ...
      <div class="flex-1 flex flex-col overflow-auto">
        <div class="flex-1 flex flex-col">
          <div class="container mx-auto py-16 overflow-hidden flex-1">
            <div
              class="shadow-xl mx-auto flex rounded-3xl px-12 py-8 flex-col max-w-3xl gap-8 bg-white"
            >
              <app-form></app-form>
              <footer class="flex justify-end text-gray-800">
                <a class="flex gap-2 items-center" href="/">
                  ...
                  <span>DMP</span>
                  <span class="font-thin -ml-1">Schema Service</span>
                </a>
              </footer>
            </div>
          </div>
