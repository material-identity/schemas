...
/
        ...
        <fo:flow flow-name="xsl-region-body" font-family="NotoSans, NotoSansSC">
          ...
          <xsl:variable name="Parties" select="Root/DigitalMaterialPassport/Parties" />
          <xsl:variable name="ForestPlots" select="Root/DigitalMaterialPassport/ForestPlots" />
          ...
          <fo:block font-size="8pt">
              ...
              <fo:table-body>
                ...
                <fo:table-row>
                  <xsl:call-template name="PartyInfo">
                    ...
                    <xsl:with-param name="party" select="$Parties/Supplier" />
                  </xsl:call-template>
                  <xsl:call-template name="PartyInfo">
                    <xsl:with-param name="title" select="$i18n/DigitalMaterialPassport/Producer" />
                    <xsl:with-param name="party" select="$Parties/Producer" />
                  </xsl:call-template>
                </fo:table-row>
              </fo:table-body>
            </fo:table>
            ...
            <!-- Forest Plots -->
            <xsl:call-template name="SectionTitle">
              <xsl:with-param name="title" select="$i18n/DigitalMaterialPassport/ForestPlots" />
            </xsl:call-template>
            <xsl:for-each select="$ForestPlots">
            ...
            <xsl:for-each select="$Products">
              ...
              <fo:block font-style="italic" text-decoration="underline" padding-bottom="{$cellPaddingBottom}">
                <xsl:value-of select="$i18n/DigitalMaterialPassport/SpeciesList" />
              </fo:block>
              <xsl:call-template name="GenerateSpeciesTable">
                <xsl:with-param name="Section" select="SpeciesList" />
            ...
            <xsl:if test="exists($Documents)">
              <xsl:call-template name="SectionTitle">
                <xsl:with-param name="title" select="$i18n/DigitalMaterialPassport/Documents" />
              </xsl:call-template>
              <fo:table table-layout="fixed" width="100%">
                <fo:table-column column-width="50%" />
                <fo:table-column column-width="50%" />
                <fo:table-body>
                  <fo:table-row>
                    ...
                    <fo:table-cell>
                      <fo:block font-weight="bold">
                        <xsl:value-of select="$i18n/DigitalMaterialPassport/FileName" />
                      </fo:block>
                    </fo:table-cell>
                  </fo:table-row>
