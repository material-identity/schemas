...
<xsl:stylesheet version="3.0"
    ...
    <fo:root xml:lang="en">
      ...
      <fo:page-sequence master-reference="simple">
        ...
        <fo:static-content flow-name="xsl-region-after">
          <fo:block font-size="8pt" text-align="center" margin-right="1cm"
            font-family="NotoSans, NotoSansSC">
        ...
        <fo:flow flow-name="xsl-region-body" font-family="NotoSans, NotoSansSC">
          ...
          <xsl:variable name="GeneralInformation"
            select="Root/DigitalMaterialPassport/GeneralInformation" />
          ...
          <xsl:variable name="DueDiligenceStatement"
            select="Root/DigitalMaterialPassport/DueDiligenceStatement" />
          ...
          <fo:block font-size="8pt">
            ...
            <xsl:call-template name="SectionTitle">
              <xsl:with-param name="title"
                select="$i18n/DigitalMaterialPassport/DigitalMaterialPassport" />
            </xsl:call-template>
            <fo:table table-layout="fixed" width="100%">
              <fo:table-column column-width="50%" />
              <fo:table-column column-width="50%" />
              <fo:table-body>
                <fo:table-row>
                  <xsl:call-template name="KeyValue">
                    ...
                    <xsl:with-param
                      name="value" select="Root/DigitalMaterialPassport/Id" />
                    <xsl:with-param
                      name="paddingBottom" select="$cellPaddingBottom" />
                  </xsl:call-template>
                </fo:table-row>
                <fo:table-row>
                  <xsl:call-template name="KeyValue">
                    ...
                    <xsl:with-param
                      name="value" select="Root/DigitalMaterialPassport/Date" />
                    <xsl:with-param
                      name="paddingBottom" select="$cellPaddingBottom" />
                  </xsl:call-template>
                </fo:table-row>
            ...
            <xsl:if test="exists($GeneralInformation)">
              <xsl:call-template name="SectionTitle">
                <xsl:with-param name="title"
                  select="$i18n/DigitalMaterialPassport/GeneralInformation" />
              </xsl:call-template>
              <fo:table
                ...
                <fo:table-body>
                  <fo:table-row>
                    <xsl:call-template name="KeyValue">
                      <xsl:with-param name="key"
                        select="$i18n/DigitalMaterialPassport/UserDefinedId" />
                      <xsl:with-param
                        name="value" select="$GeneralInformation/UserDefinedId" />
                      <xsl:with-param
                        name="paddingBottom" select="$cellPaddingBottom" />
                    </xsl:call-template>
                  </fo:table-row>
                  <fo:table-row>
                    <xsl:call-template name="KeyValue">
                      ...
                      <xsl:with-param
                        name="value" select="$GeneralInformation/Country" />
                      <xsl:with-param
                        name="paddingBottom" select="$cellPaddingBottom" />
                    </xsl:call-template>
                  </fo:table-row>
                  <xsl:if test="exists($GeneralInformation/State)">
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        ...
                        <xsl:with-param
                          name="value" select="$GeneralInformation/State" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
            ...
            <xsl:for-each select="$Products">
                ...
                <fo:table-body>
                  <xsl:if test="exists(DescriptionOfProduct)">
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        <xsl:with-param name="key"
                          select="$i18n/DigitalMaterialPassport/DescriptionOfProduct" />
                        <xsl:with-param
                          name="value" select="DescriptionOfProduct" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                  ...
                  <xsl:if test="exists(ProductionPeriod)">
                    <fo:table-row>
                      <fo:table-cell>
                        <fo:block font-style="italic" text-decoration="underline"
                    ...
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        ...
                        <xsl:with-param
                          name="value" select="ProductionPeriod/StartDate" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        ...
                        <xsl:with-param
                          name="value" select="ProductionPeriod/EndDate" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
              ...
              <xsl:if
                test="exists(ListOfSpecies)">
                <xsl:call-template name="GenerateSpeciesTable">
                  <xsl:with-param name="Section" select="ListOfSpecies" />
                  <xsl:with-param
                    name="CommonNameTranslation" select="$i18n/DigitalMaterialPassport/CommonName" />
                  <xsl:with-param
                    name="ScientificNameTranslation"
                    select="$i18n/DigitalMaterialPassport/ScientificName" />
                  <xsl:with-param
                    name="GenusTranslation" select="$i18n/DigitalMaterialPassport/Genus" />
                  <xsl:with-param
                    name="SpeciesTranslation" select="$i18n/DigitalMaterialPassport/Species" />
                  <xsl:with-param
                    name="QuantityTranslation" select="$i18n/DigitalMaterialPassport/Quantity" />
                  <xsl:with-param
                    name="paddingBottom" select="$cellPaddingBottom" />
                </xsl:call-template>
              </xsl:if>
                ...
                <fo:table-body>
                  <xsl:if test="exists($PurchaseOrder/Id)">
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        ...
                        <xsl:with-param
                          name="value" select="$PurchaseOrder/Id" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                  ...
                  <xsl:if test="exists($PurchaseOrder/Position)">
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        ...
                        <xsl:with-param
                          name="value" select="$PurchaseOrder/Position" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                  ...
                  <xsl:if test="exists($PurchaseOrder/Date)">
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        <xsl:with-param name="key" select="$i18n/DigitalMaterialPassport/Date" />
                        <xsl:with-param
                          name="value" select="$PurchaseOrder/Date" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                  ...
                  <xsl:if test="exists($PurchaseOrder/CustomerProductId)">
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        <xsl:with-param name="key"
                          select="$i18n/DigitalMaterialPassport/CustomerProductId" />
                        <xsl:with-param
                          name="value" select="$PurchaseOrder/CustomerProductId" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                  ...
                  <xsl:if test="exists($PurchaseOrder/CustomerProductName)">
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        <xsl:with-param name="key"
                          select="$i18n/DigitalMaterialPassport/CustomerProductName" />
                        <xsl:with-param
                          name="value" select="$PurchaseOrder/CustomerProductName" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                ...
                <fo:table-body>
                  <xsl:if test="exists($SalesOrder/Id)">
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        <xsl:with-param name="key" select="$i18n/DigitalMaterialPassport/Id" />
                        <xsl:with-param
                          name="value" select="$SalesOrder/Id" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                  ...
                  <xsl:if test="exists($SalesOrder/Position)">
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        <xsl:with-param name="key" select="$i18n/DigitalMaterialPassport/Position" />
                        <xsl:with-param
                          name="value" select="$SalesOrder/Position" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                  ...
                  <xsl:if test="exists($SalesOrder/Date)">
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        <xsl:with-param name="key" select="$i18n/DigitalMaterialPassport/Date" />
                        <xsl:with-param
                          name="value" select="$SalesOrder/Date" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                  ...
                  <xsl:if test="exists($SalesOrder/CertificationNumber)">
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        <xsl:with-param name="key"
                          select="$i18n/DigitalMaterialPassport/CertificationNumber" />
                        <xsl:with-param
                          name="value" select="$SalesOrder/CertificationNumber" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                  ...
                  <xsl:if test="exists($SalesOrder/CertificationClaim)">
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        <xsl:with-param name="key"
                          select="$i18n/DigitalMaterialPassport/CertificationClaim" />
                        <xsl:with-param
                          name="value" select="$SalesOrder/CertificationClaim" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                  ...
                  <xsl:if test="exists($SalesOrder/CertificationPercentage)">
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        <xsl:with-param name="key"
                          select="$i18n/DigitalMaterialPassport/CertificationPercentage" />
                        <xsl:with-param
                          name="value" select="$SalesOrder/CertificationPercentage" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                  ...
                  <xsl:if test="exists($SalesOrder/Incoterms)">
                    ...
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        ...
                        <xsl:with-param
                          name="value" select="$SalesOrder/Incoterms/incoterm/code" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                    <fo:table-row>
                      <xsl:call-template name="KeyValue">
                        <xsl:with-param name="key"
                          select="$i18n/DigitalMaterialPassport/Description" />
                        <xsl:with-param
                          name="value" select="$SalesOrder/Incoterms//incoterm/description" />
                        <xsl:with-param
                          name="paddingBottom" select="$cellPaddingBottom" />
                      </xsl:call-template>
                    </fo:table-row>
                  ...
                  <fo:table-row>
                    <fo:table-cell>
                      <fo:block padding-bottom="{$cellPaddingBottom}"
                        font-family="NotoSans, NotoSansSC" font-style="italic">
            ...
            <xsl:if test="exists($DueDiligenceStatement)">
              <xsl:call-template name="SectionTitle">
                <xsl:with-param name="title"
                  select="$i18n/DigitalMaterialPassport/DueDiligenceStatement" />
              </xsl:call-template>
              <xsl:for-each
                select="tokenize($DueDiligenceStatement, '&#10;')">
                <fo:block>
                  <xsl:value-of select="." />
                </fo:block>
              </xsl:for-each>
            ...
            <fo:table table-layout="fixed" margin-top="16pt" width="100%">
              ...
              <fo:table-body>
                <fo:table-row>
                  <fo:table-cell>
                    <fo:block> Data schema maintained by <fo:basic-link
  ...
  <xsl:template
    ...
    <fo:block font-size="10pt" font-weight="bold" text-align="left"
      space-before="12pt" space-after="6pt" border-bottom="solid 1pt black">
  ...
  <xsl:template name="KeyValue">
    ...
    <fo:table-cell>
      <fo:block padding-bottom="{$paddingBottom}" font-family="NotoSans, NotoSansSC"
        font-style="italic">
  ...
  <xsl:template
    name="GenerateCoordinatesTable">
    <xsl:param name="headerCount" />
    <xsl:param name="Section" />
    <xsl:param
      name="latitudeTranslation" />
